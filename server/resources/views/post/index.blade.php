...
<div>
    <div class="flex items-end">
        <h1 class="text-6xl">All Post</h1>
        <a class="bg-gray-600 ml-auto text-white text-base p-2 rounded-md" href="{{ route('post.create') }}">Create post</a>
    </div>
